...
declare function vault_read(key_ptr: i64): i64;
@external("extism:host/user", "contacts_manage")
declare function contacts_manage(request_ptr: i64): i64;
@external("extism:host/user", "chat_manage")
declare function chat_manage(request_ptr: i64): i64;
@external("extism:host/user", "agent_infer")
declare function agent_infer(request_ptr: i64): i64;
@external("extism:host/user", "notifications_notify")
declare function notifications_notify(request_ptr: i64): i64;
