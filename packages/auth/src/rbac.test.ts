...
`);
    ...
    it('should load policies from TOML', () => {
    ...
    it('should allow operator to manage containers', () => {
        const engine = new PolicyEngine();
        engine.load(policyPath);
    ...
    it('should deny operator vault access', () => {
        const engine = new PolicyEngine();
        engine.load(policyPath);
    ...
    it('should allow agent scoped container access', () => {
        const engine = new PolicyEngine();
        engine.load(policyPath);
    ...
    it('should deny agent access to non-agent resources', () => {
        const engine = new PolicyEngine();
        engine.load(policyPath);
    ...
    it('should enforce and throw on denied permission', () => {
        const engine = new PolicyEngine();
        engine.load(policyPath);
    ...
    it('should not throw for allowed permission on enforce', () => {
        const engine = new PolicyEngine();
        engine.load(policyPath);
    ...
    it('should evaluate multiple roles (union)', () => {
        const engine = new PolicyEngine();
        engine.load(policyPath);
