...
interface ChatSession { id: string; agentId?: string; workflowId?: string; modelId?: string; providerId?: string; mode?: string; title: string; toolIds: string[]; mcpServerIds?: string[]; headMessageId?: string | null; createdAt: string; updatedAt: string; }
interface ChatMessage { id: string; sessionId: string; parentId?: string | null; branch?: string; role: string; content: string; providerType?: string; modelId?: string; toolCalls?: unknown[]; toolResults?: unknown[]; finishReason?: string; usage?: Record<string, unknown>; latencyMs?: number; metadata?: Record<string, unknown>; createdAt: string; }
